...
#define WINHELP_CTX_keyboard_rightalt "keyboard.rightalt:config-custom-rightalt"
#define WINHELP_CTX_keyboard_altmeta "keyboard.altmetabit:config-custom-altmeta"
...
#define WINHELP_CTX_behaviour_switchwin "behaviour.switchwin:config-custom-switchwin"
#define WINHELP_CTX_behaviour_switchskipmin "behaviour.switchskipmin:config-custom-switchskipmin"
...
#define WINHELP_CTX_wallpaper_backmode "wallpaper.backmode:config-background-mode"
#define WINHELP_CTX_wallpaper_backtrans "wallpaper.backtrans:config-background-transparency"
#define WINHELP_CTX_wallpaper_backimage "wallpaper.backimage:config-background-image"
#define WINHELP_CTX_icon_titlebar "icon.titlebar:config-icon-titlebar"
...
#define WINHELP_CTX_translation_use5casis "translation.use5casis:config-custom-use5casis"
