...
#define FILTER_IMAGE_FILES (L"Bitmap Files (*.bmp)\0*.bmp\0" \
                            L"All Files (*.*)\0*\0\0\0")
#define FILTER_ICON_FILES (L"Icon Files (*.ico)\0*.ico\0" \
                           L"Module Files (*.exe;*.dll)\0*.exe;*.dll\0" \
                           L"All Files (*.*)\0*\0\0\0")
...
#define FILTER_IMAGE_FILES_C ("Bitmap Files (*.bmp)\0*.bmp\0" \
                              "All Files (*.*)\0*\0\0\0")
#define FILTER_ICON_FILES_C ("Icon Files (*.ico)\0*.ico\0" \
